...
case('rho_val')
  read(50,*,err=20) rho_val
case('pt_core')
  read(50,*,err=20) pt_core
  if (pt_core) then
   read(50,*,err=20) ntype
   if (allocated(crst_in)) deallocate(crst_in)
   allocate(crst_in(ntype))
   read(50,*,err=20) (crst_in(i),i=1,ntype)
  endif
case('npsden')
...
case('G0W0')
  ...
  read(50,*,err=20) qpnb(1),qpnb(2)
  del_e=del_e/ha2ev
case('gw0step')
  read(50,*,err=20) gw0step
  if (gw0step.le.0) then
   write(*,'("gw0step <= 0")')
   stop
  endif
case('scgwni')
  read(50,*,err=20) scgwni
  if (scgwni.le.0) then
   write(*,'("scgwni <= 0")')
   stop
  endif
case('gw_restart')
  read(50,*,err=20) gw_restart
case('core_exx')
  read(50,*,err=20) core_exx
case('nebd_chi')
  read(50,*,err=20) nebd_chi
case('nebd_se')
  read(50,*,err=20) nebd_se
case('caltype')
  read(50,*,err=20) caltype
case('exxtype')
  read(50,*,err=20) exxtype
case('bhbar')
  read(50,*,err=20) bhbar
  bhbar=bhbar*ha2ev
case('upm')
  read(50,*,err=20) upm(1),upm(2)
case('raicut')
  read(50,*,err=20) raicut(1),raicut(2)
case('lr_nw')
  read(50,*,err=20) lr_nw
case('niw')
  read(50,*,err=20) niw
case('ac_sigma')
  read(50,*,err=20) ac_sigma
case('cpe_alp0')
  read(50,*,err=20) cpe_alp0
case('cpe_sig0')
  read(50,*,err=20) cpe_sig0
case('cpe_gtor')
  read(50,*,err=20) cpe_gtor
case('cpe_delta')
  read(50,*,err=20) cpe_delta
case('cpe_N')
  read(50,*,err=20) cpe_N
case('gf_niw')
  read(50,*,err=20) gf_niw
case('lr_eta')
  read(50,*,err=20) lr_eta
  lr_eta=lr_eta/ha2ev
case('dyson_mu')
  read(50,*,err=20) dyson_mu
  dyson_mu=dyson_mu/ha2ev
case('occ_tor')
  read(50,*,err=20) occ_tor
case('gw_band')
  read(50,*,err=20) gwband
case('gwband_sp')
  read(50,*,err=20) gwband_sp
case('eval_udt')
  read(50,*,err=20) eval_udt
case('response_iw')
  timgw=.true.
